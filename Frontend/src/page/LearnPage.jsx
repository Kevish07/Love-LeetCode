...
import { Book, Code, Target, Trophy, ChevronRight, Clock, ArrowLeft } from "lucide-react";
  ...
  const learningPaths = [
    {
      id: "coding-rookie",
      title: "Coding Rookie",
      description: "Perfect for absolute beginners taking their first steps into programming",
      icon: Book,
    ...
    },
    {
      id: "code-explorer",
      title: "Code Explorer",
      description: "Designed for beginners who understand basics and want to build confidence",
      icon: Target,
      color: "text-blue-400",
    ...
    },
    {
      ...
      description: "For intermediate programmers ready to master algorithms and data structures",
      icon: Code,
      ...
      topics: [
        ...
        },
        {
          ...
          problems: [
            ...
            { id: "32", title: "Search in Rotated Array", difficulty: "Medium" },
    ...
    },
    {
      ...
      description: "Advanced challenges for seasoned programmers aiming for mastery",
      icon: Trophy,
      ...
      topics: [
        {
          ...
          completed: false,
          problems: [
            { id: "37", title: "Longest Common Subsequence", difficulty: "Hard" },
          ...
          <>
            ...
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Carefully crafted curriculum designed for every level of coder. Choose your journey and master programming step by step.
              </p>
            </div>
                  ...
                  >
                    <CardHeader>
                      <div className="flex items-center space-x-3 mb-2">
                        <div className={`p-3 rounded-xl bg-gradient-to-r ${path.bgGradient}`}>
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-1 mt-2">
                            ...
                            <span className="text-sm text-slate-400">{path.estimatedTime}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <CardContent>
                      <div className="mb-4">
                        <p className="text-sm text-slate-400 mb-2">Topics covered: {path.topics.length}</p>
                        <div className="flex flex-wrap gap-2">
                          {path.topics.slice(0, 3).map((topic) => (
                            <Badge key={topic.id} variant="secondary" className="text-xs bg-purple-500/20 text-purple-300">
                              {topic.name}
                            </Badge>
                          ))}
