        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Follow our carefully crafted curriculum designed for every level of coder.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              {[
                { title: "Fundamentals", problems: 150, difficulty: "Beginner", color: "green" },
                { title: "Arrays & Strings", problems: 200, difficulty: "Easy-Medium", color: "blue" },
                { title: "Linked Lists & Trees", problems: 180, difficulty: "Medium", color: "yellow" },
                { title: "Dynamic Programming", problems: 120, difficulty: "Medium-Hard", color: "purple" },
                { title: "Graph Algorithms", problems: 100, difficulty: "Hard", color: "red" },
                { title: "System Design", problems: 50, difficulty: "Expert", color: "cyan" },
              ].map((path, index) => (
                <Card
                  key={index}
